...
namespace MIC.Wpf.Controls.Buttons
{
    //My class taken from sealed official ButtonChrome cls
    public sealed class ButtonChromeEx : Decorator
    {
        ...
        public static readonly DependencyProperty BackgroundProperty = Control.BackgroundProperty.AddOwner(typeof(ButtonChromeEx), new FrameworkPropertyMetadata(null, FrameworkPropertyMetadataOptions.AffectsRender));
        public static readonly DependencyProperty BorderBrushProperty = Border.BorderBrushProperty.AddOwner(typeof(ButtonChromeEx), new FrameworkPropertyMetadata(null, FrameworkPropertyMetadataOptions.AffectsRender));
        public static readonly DependencyProperty RenderDefaultedProperty = DependencyProperty.Register("RenderDefaulted", typeof(bool), typeof(ButtonChromeEx), new FrameworkPropertyMetadata(false, new PropertyChangedCallback(ButtonChromeEx.OnRenderDefaultedChanged)));
        public static readonly DependencyProperty RenderMouseOverProperty = DependencyProperty.Register("RenderMouseOver", typeof(bool), typeof(ButtonChromeEx), new FrameworkPropertyMetadata(false, new PropertyChangedCallback(ButtonChromeEx.OnRenderMouseOverChanged)));
        public static readonly DependencyProperty RenderPressedProperty = DependencyProperty.Register("RenderPressed", typeof(bool), typeof(ButtonChromeEx), new FrameworkPropertyMetadata(false, new PropertyChangedCallback(ButtonChromeEx.OnRenderPressedChanged)));
        public static readonly DependencyProperty RoundCornersProperty = DependencyProperty.Register("RoundCorners", typeof(bool), typeof(ButtonChromeEx), new FrameworkPropertyMetadata(true, FrameworkPropertyMetadataOptions.AffectsRender));
        ...
        public static readonly DependencyProperty DisableInnerBorderProperty = DependencyProperty.Register(
            ...
            ownerType: typeof(ButtonChromeEx),
            typeMetadata: new FrameworkPropertyMetadata(
                defaultValue: true,
                flags: FrameworkPropertyMetadataOptions.AffectsRender));

        static ButtonChromeEx()
        {
            UIElement.IsEnabledProperty.OverrideMetadata(typeof(ButtonChromeEx), new FrameworkPropertyMetadata(true, FrameworkPropertyMetadataOptions.AffectsRender));
        }
        ...
        {
            ButtonChromeEx chrome = (ButtonChromeEx)o;
            if (chrome.Animates)
            {
